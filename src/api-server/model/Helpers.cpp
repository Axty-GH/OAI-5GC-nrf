...
bool fromStringValue(const std::string &inStr, bool &value) {
  bool result = true;
  inStr == "true" ? value = true : inStr == "false" ? value = false : result =
                                                          false;
  return result;
}
...
bool fromStringValue(const std::string &inStr,
                     oai::nrf::model::ServiceName &value) {
  //TODO
  return true;
}
...
bool fromStringValue(const std::string &inStr,
                     oai::nrf::model::PlmnSnssai &value) {
  //TODO
  return true;
}
bool fromStringValue(const std::string &inStr,
                     oai::nrf::model::PduSessionType &value) {
  //TODO
  return true;
}
bool fromStringValue(const std::string &inStr,
                     oai::nrf::model::EventId &value) {
  //TODO
  return true;
}
bool fromStringValue(const std::string &inStr,
                     oai::nrf::model::NwdafEvent &value) {
  //TODO
  return true;
}
bool fromStringValue(const std::string &inStr,
                     oai::nrf::model::AccessType &value) {
  //TODO
  return true;
}
bool fromStringValue(const std::string &inStr,
                     oai::nrf::model::ComplexQuery &value) {
  //TODO
  return true;
}
bool fromStringValue(const std::string &inStr,
                     oai::nrf::model::AtsssCapability &value) {
  //TODO
  return true;
}
...
bool fromStringValue(const std::string &inStr,
                     oai::nrf::model::Ipv6Prefix &value) {
  //TODO
  return true;
}
bool fromStringValue(const std::string &inStr,
                     oai::nrf::model::DataSetId &value) {
  //TODO
  return true;
}
}

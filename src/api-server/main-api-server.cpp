...
int main() {
    ...
    CompleteStoredSearchDocumentApiImpl CompleteStoredSearchDocumentApiserver(router);
    CompleteStoredSearchDocumentApiserver.init();
    NFInstancesStoreApiImpl NFInstancesStoreApiserver(router);
    NFInstancesStoreApiserver.init();
    StoredSearchDocumentApiImpl StoredSearchDocumentApiserver(router);
    StoredSearchDocumentApiserver.init();

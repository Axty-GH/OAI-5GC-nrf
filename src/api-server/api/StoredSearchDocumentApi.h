...
private:
    ...
    void retrieve_stored_search_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    void stored_search_document_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    ...
    virtual void retrieve_stored_search(const std::string &searchId, Pistache::Http::ResponseWriter &response) = 0;

...
void NFInstancesStoreApi::setupRoutes() {
    ...
    Routes::Get(*router, base + nrf_cfg.sbi_api_version+ "/nf-instances", Routes::bind(&NFInstancesStoreApi::get_nf_instances_handler, this));
    Routes::Options(*router, base + nrf_cfg.sbi_api_version+ "/nf-instances", Routes::bind(&NFInstancesStoreApi::options_nf_instances_handler, this));

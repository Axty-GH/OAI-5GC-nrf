...
void CompleteStoredSearchDocumentApi::retrieve_complete_search_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
...
void CompleteStoredSearchDocumentApi::complete_stored_search_document_api_default_handler(const Pistache::Rest::Request &, Pistache::Http::ResponseWriter response) {
